      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-muted-foreground">配色方案测试 · 实时预览</span>
          </div>
        </div>

        {/* 核心指标卡片 */}
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-6">核心指标展示</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <DashboardCard variant="primary" className="animate-card-float">
              <MetricCard variant="primary">
                ...
                <MetricValue variant="primary" size="lg" className="data-value">2,847</MetricValue>
            ...
            <DashboardCard variant="success">
              <MetricCard variant="success">
                ...
                <MetricValue variant="success" size="lg" className="data-value">1,634</MetricValue>
            ...
            <DashboardCard variant="danger">
              <MetricCard variant="danger">
                ...
                <MetricValue variant="danger" size="lg" className="data-value">321</MetricValue>
            ...
            <DashboardCard variant="warning">
              <MetricCard variant="warning">
                ...
                <MetricValue variant="warning" size="lg" className="data-value">892</MetricValue>
                <TrendIndicator trend="neutral" value="±2.1%" icon={<span>→</span>} />
              </MetricCard>
            </DashboardCard>
          </div>
        </section>
        ...
        {/* 系统状态监控 */}
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-6">系统状态监控</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex flex-wrap gap-2">
                    <SentimentBadge sentiment="very-positive">非常积极</SentimentBadge>
                    ...
                    <SentimentBadge sentiment="very-negative">非常消极</SentimentBadge>
                  </div>
                  
                  <div className="pt-4">
                    <h4 className="text-sm font-medium text-muted-foreground mb-3 ">实时状态指示器</h4>
                    <div className="flex flex-wrap gap-3">
                      <LiveIndicator status="online">数据同步正常</LiveIndicator>
        ...
        {/* 热词云展示 */}
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-6 ">热词云展示</h2>
          <DashboardCard>
            <WordcloudContainer>
              <WordcloudTag variant="primary" shine>舆情监控</WordcloudTag>
              <WordcloudTag variant="secondary" shine>数据分析</WordcloudTag>
              <WordcloudTag variant="primary">实时监控</WordcloudTag>
              <WordcloudTag variant="secondary">情感分析</WordcloudTag>
              <WordcloudTag variant="primary" shine>智能预警</WordcloudTag>
              <WordcloudTag variant="secondary">热点追踪</WordcloudTag>
              <WordcloudTag variant="primary">地理分析</WordcloudTag>
              <WordcloudTag variant="secondary" shine>趋势预测</WordcloudTag>
              <WordcloudTag variant="primary">关键词</WordcloudTag>
              <WordcloudTag variant="secondary">数据挖掘</WordcloudTag>
              <WordcloudTag variant="primary" shine>可视化</WordcloudTag>
        ...
        {/* 配色展示 */}
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-6 ">配色方案展示</h2>
        ...
        {/* 字体展示 */}
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-6 ">字体系统展示</h2>
          <DashboardCard>
            <div className="space-y-4">
              ...
              <div className="font-rubik-regular text-sm text-muted-foreground ">
                Rubik Regular - 基于人工智能的全网数据采集、情感分析、热点追踪解决方案
              </div>
            </div>
          </DashboardCard>
        </section>
