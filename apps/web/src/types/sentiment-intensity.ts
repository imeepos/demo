...
// 类型定义
export type CreateSentimentIntensityInput = z.infer<
  typeof createSentimentIntensitySchema
>;
export type SearchSentimentIntensityInput = z.infer<
  typeof searchSentimentIntensitySchema
>;
