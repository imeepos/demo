...
export const SentimentIntensityList: React.FC<SentimentIntensityListProps> = ({
      ...
      <DashboardCard className="p-8">
        <div className="flex flex-col items-center justify-center space-y-4">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">正在获取情感强度配置信息...</div>
          </div>
        </div>
      </DashboardCard>
    );
      ...
      <DashboardCard className="p-12">
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          <div className="text-center space-y-2">
            <h3 className="text-lg font-semibold text-foreground">暂无配置数据</h3>
  ...
  const getIntensityVariant = (intensity: any): 'very-positive' | 'positive' | 'neutral' | 'negative' | 'very-negative' => {
  ...
  const getProgressVariant = (intensity: any): 'success' | 'warning' | 'primary' | 'danger' => {
    const num = safeIntensity(intensity);
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-xs text-muted-foreground">
                        <span>0.000</span>
                        <span className="font-medium">{(intensityValue * 100).toFixed(1)}%</span>
                        <span>1.000</span>
                      </div>
                      <ProgressBar 
