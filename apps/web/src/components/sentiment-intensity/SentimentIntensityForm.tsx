...
import { createSentimentIntensitySchema, type CreateSentimentIntensityInput } from '../../types/sentiment-intensity';
  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        />
        {errors.intensity && (
          <p className="text-sm text-red-500">{errors.intensity.message}</p>
        )}
        <p className="text-sm text-gray-500">
          强度值范围：0.00 - 1.00，数值越大表示情感强度越高
        </p>
      </div>
